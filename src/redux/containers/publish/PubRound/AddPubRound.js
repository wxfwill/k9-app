...
class AddPubRoundComponent extends Component{
  ...
  submit = () => {
    ...
    this.props.form.validateFields((error, value) => {
        ...
        if (!error) {
            this.isRequest = true;
            Ajax.post('/api/dailyPatrols/distributeTask', {
  ...
  render(){
    const { getFieldProps } = this.props.form;
  	return(
        ...
        <Header title="发布日常巡逻"  pointer='pointer' pointer noColor/>
        <div className="list-box">
          <List className="list">
            {this.state.disabled?null:this.renderBtn(<span><i className="tips">*</i>巡逻时间</span>, '', { pickTime: true, showShortcut: true, defaultValue: [this.state.startTime?new Date(this.state.startTime):'', this.state.endTime?new Date(this.state.endTime):''] })}
          ...
          <List className="list">
            <InputItem
              ...
              clear
            ><i className="tips">*</i>任务名称</InputItem>
          </List>
          ...
          <List className="list">
             ...
             {this.state.disabled ?  <InputItem
              ...
              disabled={this.state.disabled}
            ><i className="tips">*</i>巡逻人员</InputItem>: <PeopleBox
              title="巡逻人员"     
              initTip="请选择队员"     
              searchTip="请输入查询内容"   
              disabled={this.state.disabled}
          ...
          <List className="list">
              <TextareaItem
              title={<span><i className="tips">*</i>巡逻说明</span>}
              autoHeight='true'
              clear
              disabled={this.state.disabled}

...
class OwnLevelComponent extends Component{
    ...
    goDetail = (item) => {
      ...
      history.push({pathname:'/own/leave/levelDetails', query:item.id })
    }
    ...
    getContent(data, callback){
        let _this = this;
        commonJs.ajaxPost('/api/leaveRecord/myLeaveList', {qryDate: data,currPage:this.state.currPage,pageSize:5}, function(result){
          if(result.code == 0){
    ...
    render(){
        ...
        return(
          <div className="own-listbox">
                ...
                <Header title="请假申请" isSet="添加" pointer isSearch handleShow={this.addShow.bind(this)} />
...
// WEBPACK FOOTER //
// ./src/components/own/OwnLevel/index.js
...
class ItinerancyDetail extends Component {
  ...
  componentDidMount() {
    ...
    if (this.props.history.location.query) {
      Ajax.post(
        '/api/outdoorTask/outdoorAppDetail',
        {
      ...
      <div className="Drill">
        ...
        <List style={{ backgroundColor: 'white' }} className="">
          <TextareaItem
            ...
            placeholder=""
            autoHeight
            value={this.state.itinerancyInfo.planName}
          ></TextareaItem>
          ...
          <TextareaItem
            ...
            placeholder=""
            value={
              this.state.itinerancyInfo.taskTime
                ? moment(this.state.itinerancyInfo.taskTime).format('YYYY-MM-DD')
                : '--'
            }
          ></TextareaItem>
          ...
          <TextareaItem
            ...
            placeholder=""
            autoHeight
            value={this.state.itinerancyInfo.content}
          ></TextareaItem>
        </List>
        ...
        <div className="handle">
          <Flex justify="center">
            {this.state.itinerancyInfo.status >= 2 ? (
              <Report id={this.state.itinerancyInfo.planId} type={6} />
            ) : (
              <div>
              ...
              */}
                {this.state.itinerancyInfo.status == 2 ? (
                  <Button className="end common-btn" inline>
                    完成
                  </Button>
                ) : null}
              </div>

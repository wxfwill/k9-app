...
import * as workData from 'localData/workbench/work-data.js';
...
class PublishComponent extends Component {
  ...
  handleGridItem = (obj, index) => {
    ...
    history.push(`${obj.link}?titleType=${obj.text}`);
  };
...
export default withRouter(PublishComponent);
